...
var AutoBuildTemplate = {
	...
	2:	{
			SkillPoints: [252], 											// Might + 1 (level 1)
	...
	3:	{
			SkillPoints: [253], 											// Smite + 1 (level 1)
	...
	4:	{
			SkillPoints: [251],											// Prayer + 1 (level 1)
	...
	6:	{
			SkillPoints: [258, 256],									// Holy Bolt + 1, Defiance + 1 (level 1) (level 2) (0 saved points remain)
	...
	12:	{
			...
			Update: function () {
                ...
                Config.Traps = [261,261,-1,-1,-1];
                Config.BossTraps = [261,261,261,261,261];
			}
		},

	13:	{
			SkillPoints: [251, 261, 256],											// Blessed Aim + 1 (level 2) Save Point + 1 (4 saved points remain) (Normal Den of Evil Used)
	...
	18:	{
			SkillPoints: [268, 267, 251, 256, 261],								// Blessed Hammer + 1, Concentration + 1, Vigor + 1 (level 1) (level 1) (level 1) (6 saved points remain)
			StatPoints: [0, 0, 0, 3, 3],								// Vitality + 5 (95)
			Update: function () {
				Config.AttackSkill = [-1, 251, -1, 251, 0, -1, -1];// Blessed Hammer and Concentration!
	...
	19:	{
			SkillPoints: [261],									// Blessed Hammer + 1, Concentration + 1 (level 2) (level 2) (5 saved points remain)
	...
	20:	{
			SkillPoints: [261],									// Blessed Hammer + 1, Concentration + 1 (level 3) (level 3) (4 saved points remain)
	...
	21:	{	
			SkillPoints: [261],									// Blessed Hammer + 1, Concentration + 1 (level 4) (level 4) (3 saved points remain)
	...
	22:	{
			SkillPoints: [261],									// Blessed Hammer + 1, Concentration + 1 (level 5) (level 5) (2 saved points remain)
	...
	23:	{
			SkillPoints: [261],											// Blessed Hammer + 1 (level 6) (2 saved points remain)
	...
	24:	{
			...
			Update: function () {
				Config.AttackSkill = [273, 251, 256, 251, 273, 256, 273];// Holy Bolt and Meditation for Secondary Skill/Aura.
	...
	30:	{
			SkillPoints: [276],								// Blessed Hammer + 1, Blessed Aim + 2 (level 13) (level 5) (Norm Izual)
			StatPoints: [3, 3, 3, 3, 3, 3, 3, 3, 3, 3],					// Vitality + 10 (160) (Norm Lam Esen's Tome)
			Update: function () {
				Config.AttackSkill = [273, 251, 256, 251, 273, 256, 273];
	...
	31:	{	
			SkillPoints: [271],											// Blessed Hammer + 1 (level 14)
	...
	32:	{
			SkillPoints: [276],											// Blessed Hammer + 1 (level 15)
	...
	33:	{
			SkillPoints: [271],											// Blessed Hammer + 1 (level 16)
	...
	34:	{
			SkillPoints: [271],											// Blessed Hammer + 1 (level 17)
	...
	35:	{
			SkillPoints: [276],											// Blessed Hammer + 1 (level 18)
	...
	36:	{
			SkillPoints: [271],											// Blessed Hammer + 1 (level 19)
	...
	37:	{
			SkillPoints: [271],											// Blessed Hammer + 1 (level 20)
	...
	38:	{
			SkillPoints: [271],											// Concentration + 1 (level 6)
	...
	39:	{
			SkillPoints: [271],											// Concentration + 1 (level 7)
	...
	40:	{
			SkillPoints: [271],											// Concentration + 1 (level 8)
	...
	41:	{	
			SkillPoints: [271],											// Concentration + 1 (level 9)
	...
	42:	{
			SkillPoints: [271],											// Concentration + 1 (level 10)
	...
	43:	{
			SkillPoints: [271],						// Concentration + 1, Blessed Aim + 4 (level 11) (level 9) (NM Den of Evil, NM Radament, NM Izual)
	...
	44:	{
			SkillPoints: [271],											// Concentration + 1 (level 12)
	...
	45:	{
			SkillPoints: [271],											// Concentration + 1 (level 13)
	...
	46:	{
			SkillPoints: [271, 276],											// Concentration + 1 (level 14)
	...
	47:	{
			SkillPoints: [276, 276],											// Concentration + 1 (level 15)
	...
	48:	{
			SkillPoints: [276],											// Concentration + 1 (level 16)
	...
	49:	{
			SkillPoints: [276],											// Concentration + 1 (level 17)
	...
	50:	{
			SkillPoints: [276],											// Concentration + 1 (level 18)
	...
	51:	{	
			SkillPoints: [276],											// Concentration + 1 (level 19)
	...
	52:	{
			SkillPoints: [276],											// Concentration + 1 (level 20)
	...
	53:	{
			SkillPoints: [276],											// Vigor + 1 (level 2)
	...
	54:	{
			SkillPoints: [276],											// Vigor + 1 (level 3)
	...
	55:	{
			SkillPoints: [276],											// Vigor + 1 (level 4)
	...
	56:	{
			SkillPoints: [276],											// Vigor + 1 (level 5)
	...
	57:	{
			SkillPoints: [276],											// Vigor + 1 (level 6)
	...
	58:	{
			SkillPoints: [276],											// Vigor + 1 (level 7)
	...
	59:	{
			SkillPoints: [276],											// Vigor + 1 (level 8)
	...
	60:	{
			SkillPoints: [276, 276],											// Vigor + 1 (level 9)
	...
	61:	{	
			SkillPoints: [251],											// Vigor + 1 (level 10)
	...
	62:	{
			SkillPoints: [251],											// Vigor + 1 (level 11)
	...
	63:	{
			SkillPoints: [251],											// Vigor + 1 (level 12)
	...
	64:	{
			SkillPoints: [251],											// Vigor + 1 (level 13)
	...
	65:	{
			SkillPoints: [251],											// Vigor + 1 (level 14)
	...
	66:	{
			SkillPoints: [251],											// Vigor + 1 (level 15)
	...
	67:	{
			SkillPoints: [251],											// Vigor + 1 (level 16)
	...
	68:	{
			SkillPoints: [251],											// Vigor + 1 (level 17)
	...
	69:	{
			SkillPoints: [251],											// Vigor + 1 (level 18)
	...
	70:	{
			SkillPoints: [251],						// Vigor + 1, Blessed Aim + 4 (level 19) (level 13) (Hell Den of Evil, Hell Radament, Hell Izual)
	...
	71:	{	
			SkillPoints: [251],											// Vigor + 1 (level 20)
	...
	72:	{
			SkillPoints: [251],											// Blessed Aim + 1 (level 14)
	...
	73:	{
			SkillPoints: [251],											// Blessed Aim + 1 (level 15)
	...
	74:	{
			SkillPoints: [251],											// Blessed Aim + 1 (level 16)
	...
	75:	{
			SkillPoints: [251, 261, 261],											// Blessed Aim + 1 (level 17)
	...
	76:	{
			SkillPoints: [251],											// Blessed Aim + 1 (level 18)
	...
	77:	{
			SkillPoints: [251],											// Blessed Aim + 1 (level 19)
	...
	78:	{
			SkillPoints: [256],											// Blessed Aim + 1 (level 20)
	...
	79:	{
			SkillPoints: [256],											// Holy Shield + 1 (level 2)
	...
	80:	{
			SkillPoints: [256],											// Holy Shield + 1 (level 3)
	...
	81:	{	
			SkillPoints: [256],											// Holy Shield + 1 (level 4)
	...
	82:	{
			SkillPoints: [256],											// Holy Shield + 1 (level 5)
	...
	83:	{
			SkillPoints: [256],											// Holy Shield + 1 (level 6)
	...
	84:	{
			SkillPoints: [256],											// Holy Shield + 1 (level 7)
	...
	85:	{
			SkillPoints: [256],											// Holy Shield + 1 (level 8)
	...
	86:	{
			SkillPoints: [256],											// Holy Shield + 1 (level 9)
	...
	87:	{
			SkillPoints: [256],											// Holy Shield + 1 (level 10)
	...
	88:	{
			SkillPoints: [256],											// Holy Shield + 1 (level 11)
	...
	89:	{
			SkillPoints: [256],											// Holy Shield + 1 (level 12)
	...
	90:	{
			SkillPoints: [256],											// Holy Shield + 1 (level 13)
	...
	91:	{	
			SkillPoints: [256],											// Holy Shield + 1 (level 14)
	...
	92:	{
			SkillPoints: [256],											// Holy Shield + 1 (level 15)
	...
	93:	{
			SkillPoints: [256],											// Holy Shield + 1 (level 16)
	...
	94:	{
			SkillPoints: [261],											// Holy Shield + 1 (level 17)
	...
	95:	{
			SkillPoints: [261],											// Holy Shield + 1 (level 18)
	...
	96:	{
			SkillPoints: [261],											// Holy Shield + 1 (level 19)
	...
	97:	{
			SkillPoints: [261],											// Holy Shield + 1 (level 20)
