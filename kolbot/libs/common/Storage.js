...
var Storage = new function () {
	this.Init = function () {
		this.StashY = me.gametype === 0 ? 4 : 16;
		this.Inventory = new Container("Inventory", 16, 16, 3);
		this.TradeScreen = new Container("Inventory", 10, 4, 5);
		this.Stash = new Container("Stash", 14, this.StashY, 7);
		this.Belt = new Container("Belt", 4 * this.BeltSize(), 1, 2);
		this.Cube = new Container("Horadric Cube", 16, 16, 6);
		this.InvRef = [];
