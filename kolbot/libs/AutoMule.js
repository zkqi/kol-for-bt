var AutoMule = {
	Mules: {
		"Mule1":  {
			muleProfile: "ck",  // The name of mule profile in d2bot#. It will be started and stopped when needed.
			accountPrefix: "ggffck",  // Account prefix. Numbers added automatically when making accounts.
			accountPassword: "11",  // Account password.
			charPrefix: "ggffck",  // Character prefix. Suffix added automatically when making characters.
		...
		if (item) {
			do {
				if (Town.ignoredItemTypes.indexOf(item.itemType) === -1 &&
						...
						[666, 667, 674, 675, 742, 769, 770,].indexOf(item.classid) === -1 && // Don't drop ¾Õ»¨ÌØÉ«ÎïÆ·
